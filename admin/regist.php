            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Create an Account employee</h5>
                    <p class="text-center small">Enter your personal details to create account</p>
                  </div>

                  <form action="save_employee.php" class="row g-3 needs-validation" novalidate  method="post">
                    <div class="col-12">
                      <label for="yourName" class="form-label">Frist Name</label>
                      <input type="text" name="fname" class="form-control" id="yourName" required>
                      <div class="invalid-feedback">Please, enter  Frist name! </div>
                    </div>

                    <div class="col-12">
                      <label for="yourName" class="form-label">Second Name</label>
                    ...
                    <div class="col-12">
                      <label for="yourName" class="form-label">Number Phone</label>
                      <input type="text" name="phone" class="form-control" id="yourName" required>
                      <div class="invalid-feedback">Please, enter Number Phone! </div>
                    </div>
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="text" name="status" class="form-control" id="yourUsername" required>
                        <div class="invalid-feedback">Stutus.</div>
                      </div>
                    </div>
